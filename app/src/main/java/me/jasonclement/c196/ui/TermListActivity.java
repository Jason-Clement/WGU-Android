...
import me.jasonclement.c196.models.TermListViewModel;
...
public class TermListActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TermListViewModel viewModel = ViewModelProviders.of(this).get(TermListViewModel.class);
        Intent clickIntent = new Intent(this, TermActivity.class);
